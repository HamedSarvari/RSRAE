...
# Takes dataset name and relative address of dataset file to this file
def Read_data(dataset, data_add, type= 'arff', normalization='minmax'):
    if type == 'arff':

        address =  data_add + dataset + '.arff'
        #address = './outlier_detection/DataSets/' + dataset + '.arff'
        ...
        address = data_add + 'MNIST/MNIST_inlier=' + dataset + '.csv'

        #address = './outlier_detection/DataSets/' + 'MNIST/MNIST_inlier=' + str(dataset) + '.csv'
    ...
    return np.array(data_normal), np.array(labels)
